    ...
    implements SecurityAuthority
{
     ...
     * 
     * @param passwd the password that this class should return when asked
     *            for credentials.
     */
    ...
    public UserCredentials obtainCredentials(String realm,
        UserCredentials defaultValues, int reasonCode)
    {
    ...
    /**
     * Sets the userNameEditable property, which should indicate if the user
     * name could be changed by user or not.
     * 
